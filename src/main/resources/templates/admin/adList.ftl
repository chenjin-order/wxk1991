        ...
        <div class="panel-body">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="adTypeTitle" id="adTypeTitle"
                               placeholder="类型名称">
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="panel col-sm-12">
        <div class="panel-body">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="adTitle" class="col-sm-2">图片地址：</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="adImgUrl" id="adImgUrl" placeholder="图片地址">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control form-datetime" name="adBeginTime" id="adBeginTime"
                               placeholder="开始时间" readonly="readonly">
                    </div>
                    <label for="adEndTime" class="col-sm-2">结束时间：</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control form-datetime" name="adEndTime" id="adEndTime"
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th style="width: 120px;text-align: center;">添加广告时间</th>
                    <th>操作</th>
                </tr>
                </thead>
                <tbody>
